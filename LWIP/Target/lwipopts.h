...
/*-----------------------------------------------------------------------------*/
/* USER CODE BEGIN 1 */
/* Enable DNS so we can resolve the stock-API host (e.g. rozakos.eu).
 * CubeMX leaves LWIP_DNS off by default; override it here (this USER CODE
 * block is preserved across regeneration). */
#define LWIP_DNS                1
